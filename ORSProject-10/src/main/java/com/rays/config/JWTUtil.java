 ...
 * - Generate JWT tokens
 * - Validate JWT tokens
 * - Extract claims (loginId, userId, role)
 * - Handle encoding, decoding, and signing
 * 
 * This implementation uses HMAC SHA256 (HS256) algorithm.
 * 
 * JWT Structure:
...
public class JWTUtil {
	 ...
	 * @param loginId login ID (subject)
	 ...
	 * @param expectedLoginId expected loginId (subject)
	 ...
	 * 
	 * @param payloadJson JWT payload JSON
	...
	/**
	 * Extracts specific field from JSON payload.
	 * 
	...
	/**
	 * Signs data using HmacSHA256 algorithm.
	 * 
	...
	/**
	 * Encodes string to Base64 URL-safe format.
	 * 
	...
	/**
	 * Encodes byte array to Base64 URL-safe format.
	 * 
