 ...
 * for UserDTO using JPA Criteria API.
 * 
 * Features:
 * - Populates role name and additional user details
 * - Handles deletion of associated attachments (profile image)
...
public class UserDAOImpl extends BaseDAOImpl<UserDTO> implements UserDAOInt {
	...
	/**
	 * Populates additional fields such as:
	 * - Role Name
	 * - Last Login
	 * - Profile Image ID
	 * 
	...
	/**
	 * Deletes user along with associated profile image (if exists).
	 * 
	 * @param dto UserDTO object
	 * @param userContext current user context
	 */
	...
	/**
	 * Builds dynamic where clause for User search.
	 * 
	 * Filters applied:
	 * - First Name (starts with)
	 * - Login ID (starts with)
	 * - Role ID (exact match)
	 * - Date of Birth (exact match)
	 * - Status (exact match)
	 * 
	 * @param dto UserDTO containing search criteria
