...
/**
 * DTO class for Faculty entity.
 * 
 * This class represents faculty details in the system.
 * It extends BaseDTO to inherit common fields like id,
 * created/modified details.
 * 
 * Features:
 * - Stores faculty personal and professional details
 * - Maintains relationships with College, Course, and Subject
 * - Provides unique key and label for identification
 * 
 * Mapped to table: st_faculty
 * 
